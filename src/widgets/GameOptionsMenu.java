...
public class GameOptionsMenu {
	...
	public void initialize(Graphics g) {
		...
		buttons[0] = new MenuButton("<< Back", new Vector2f(position.x + 50, position.y + 50), new Vector2f(100, 50), "BACK");
		buttons[1] = new MenuButton("Quit", new Vector2f(position.x + 50, position.y + 150), new Vector2f(100, 50), "QUIT");
